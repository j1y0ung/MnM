...
<br><h1 align="center">펀딩 아이템 등록하기</h1><br>
	<div class="row-lg-10">
		<form:form action="/crowdFunding/add" modelAttribute="crowdFundingItem" method="post" enctype="multipart/form-data">
		<div class="row-lg-10">
		  ...
		  <div class="row-lg-10">
		  	<div class="form-group">-->
		  		<input type="submit" class="btn btn-primary btn-lg" value="등록 요청하기">
            </div>
		  </div>
		</form:form> 
	</div>						
