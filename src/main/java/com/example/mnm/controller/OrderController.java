...
import com.example.mnm.service.OrderValidator;
...
public class OrderController {
	...
	public String initNewOrder(HttpServletRequest request,
		...
		if (cart != null) {
			...
			Account account = mnmStore.getAccount(userSession.getAccount().getUsername());
	...
	protected ModelAndView confirmOrder(
		...
		mnmStore.insertOrder(orderForm.getOrder());
